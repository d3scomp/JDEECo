			...
			mloop: for (Object iid : rootIds) {
				...
				while (session.repeat()) {
					try {
						...
						scheduling.timestampEnsemble(this, pInfo, time, knowledgeExchange,km,cId,mId);
						//we consider the ensemble is executing synchronously on both sides "coordinator" and "member" 
						//scheduling.timestampEnsemble(this, pInfo, time, knowledgeExchange,km);
