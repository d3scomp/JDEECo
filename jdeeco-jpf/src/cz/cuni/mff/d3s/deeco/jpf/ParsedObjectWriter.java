 ...
 * {@link DEECoObjectProvider} instance to a file. Used for separating the
 * reflection part from the runtime part, which is imposed by JPF usage.
 * 
 * @author Michal
 * 
 */
public class ParsedObjectWriter {
	 ...
	 * 
	 * @param cdop
	 *            a provider to be written.
	 * @return True in case of the successful write operation. False otherwise.
	 */
	public boolean write(RuntimeMetadataProvider dop) {
		try {
