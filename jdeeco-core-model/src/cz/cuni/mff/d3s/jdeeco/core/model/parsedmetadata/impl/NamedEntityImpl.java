 ...
 * <ul>
 *   <li>{@link cz.cuni.mff.d3s.jdeeco.core.model.parsedmetadata.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedEntityImpl extends EObjectImpl implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return ParsedmodelPackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParsedmodelPackage.NAMED_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParsedmodelPackage.NAMED_ENTITY__NAME:
				return getName();
		}
