 ...
 * <ul>
 *   <li>{@link cz.cuni.mff.d3s.jdeeco.edl.model.edl.impl.NumericLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumericLiteralImpl extends MinimalEObjectImpl.Container implements NumericLiteral {
	...
	protected EClass eStaticClass() {
		return EdlPackage.Literals.NUMERIC_LITERAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdlPackage.NUMERIC_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdlPackage.NUMERIC_LITERAL__VALUE:
				return getValue();
		}
