...
public class Helicopter1sdsa {
	...
	@TimeStamp
	public Double hLPos = 0.0;
	@TimeStamp
	public Double hLSpeed = 0.0;
	...
	public Double hIntegratorSpeedError = 0.0;
	public Double hErrorWindup = 0.0;
	...
	public static void speedControl(
		...
		hIntegratorSpeedError.value += (KI_S * error + KT_S * hErrorWindup.value) * timePeriodInSeconds;
		double pidSpeed = KP_S * error + hIntegratorSpeedError.value;
