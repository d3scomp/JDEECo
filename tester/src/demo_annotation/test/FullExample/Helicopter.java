...
//			@InOut("connectedToFF") @TriggerOnValueChange ModeParamHolder<String> connectedToFF,
//			@InOut("hSearch_In") @TriggerOnValueChange("V == #hID") ModeParamHolder<String> hSearch_In
			){
...
//			@InOut("hSearch_In") @TriggerOnValueChange("V == #hID") ModeParamHolder<Double> hSearch_In,
//			@InOut("hFFPos") ModeParamHolder<Double> hFFPos,
//			@InOut("hFFSpeed") ModeParamHolder<Double> hFFSpeed,
//			@InOut("hFFTargetPos") ParamHolder<Double> hFFTargetPos,
//			@InOut("hFFTargetSpeed") ParamHolder<Double> hFFTargetSpeed
//			){
//		System.out.println("toldToSearch ...... "+hSearch_In.value);
//		hFFTargetPos.value = hFFPos.value;
//		hFFTargetSpeed.value = hFFSpeed.value;
//	}
...
//			@InOut("hSearchID") @TriggerOnValueUnchange("V != #hID") ModeParamHolder<String> hSearchID,
//			@InOut("hSearch_Out") ParamHolder<String> hSearch_Out
//		){
//		System.out.println("otherSearch ...");
