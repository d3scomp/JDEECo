package demo_annotation.test.Modes;
...
//			@InOut("lFFPos") @TriggerOnValueUnchange( equalMoreThan = 200 , lessThan = 500 , meta = MetadataType.INACCURACY) InaccuracyParamHolder<Double> lFFPos
// 			){
