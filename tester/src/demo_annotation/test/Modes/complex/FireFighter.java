...
public class FireFighter{
	...
	public static void leaderConnected(
			//from = {"","mediatorConnected"}, guard = {"LH < 1","LH > 30 || (LH > 15 && LH < 20)"}
			@InOut("ffLPos") @TriggerOnValueUnchange(from = {"","mediatorConnected"}, guard = {"LH < 1","LH > 30 || (LH > 15 && LH < 20)"}) InaccuracyParamHolder<Double> ffLPos
 			){
	...
	public static void nonWorking(
			@InOut("ffLPos") @TriggerOnValueUnchange(from = {"leaderConnected","mediatorConnected"}, guard = {"LH < 10 && LH > 8","LH < 3"}) InaccuracyParamHolder<Double> ffLPos
 			){
