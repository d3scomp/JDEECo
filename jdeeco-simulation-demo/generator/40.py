...
members = []
members.extend(aHQ.generateMembers(39))



others = []
others.extend(aHQExtended.generateOthersEdgy(20,10*SCALE_FACTOR))
...
f = open('../configurations/40/component40.cfg', 'w') 
...
f = open('../configurations/40/site40.cfg', 'w') 
print>>f, xSize, ySize
for area in [aHQ]:
    print>>f, area.toString();
f.close()

savefig("../configurations/40/cfg40.png")
show()