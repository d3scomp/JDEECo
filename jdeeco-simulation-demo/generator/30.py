...
members = []
members.extend(aHQ.generateMembers(29))



others = []
others.extend(aHQExtended.generateOthersEdgy(15,10*SCALE_FACTOR))
...
f = open('../configurations/30/component30.cfg', 'w') 
...
f = open('../configurations/30/site30.cfg', 'w') 
print>>f, xSize, ySize
for area in [aHQ]:
    print>>f, area.toString();
f.close()

savefig("../configurations/30/cfg30.png")
show()