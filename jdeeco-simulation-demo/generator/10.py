...
members = []
members.extend(aHQ.generateMembers(9))



others = []
others.extend(aHQExtended.generateOthersEdgy(5,10*SCALE_FACTOR))
...
f = open('../configurations/10/component10.cfg', 'w') 
...
f = open('../configurations/10/site10.cfg', 'w') 
print>>f, xSize, ySize
for area in [aHQ]:
    print>>f, area.toString();
f.close()

savefig("../configurations/10/cfg10.png")
show()