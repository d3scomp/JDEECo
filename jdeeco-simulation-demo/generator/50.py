...
members = []
members.extend(aHQ.generateMembers(49))
...
f = open('../configurations/50/component50.cfg', 'w') 
...
f = open('../configurations/50/site50.cfg', 'w') 
print>>f, xSize, ySize
for area in [aHQ]:
    print>>f, area.toString();
f.close()

savefig("../configurations/50/cfg50.png")
show()