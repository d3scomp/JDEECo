...
public class WrongC6 {
	...
	// rating process contains InOut parameter
	@RatingsProcess
	public static void ratingsProcess(@InOut("field1") Integer field1, @Rating("field2") ReadonlyRatingsHolder field2, @Rating("field3") RatingsHolder field3) {
