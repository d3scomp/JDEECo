...
public class PeriodicEnsembleInfo implements IPerformanceInfo {
	...
	public long R;
	public ArrayList<TimeStamp> runningPeriodsCoord=new  ArrayList<TimeStamp>();//<tsco,tfco>
	public ArrayList<TimeStamp> runningPeriodsMem=new  ArrayList<TimeStamp>();//<tsmem,tfmem>
