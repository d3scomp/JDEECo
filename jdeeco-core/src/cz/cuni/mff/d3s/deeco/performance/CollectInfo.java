...
public class CollectInfo {
	...
	public void print() {
		...
		for (int i = 0; i < ids.size(); i++) {
			...
			System.out.println(ids.get(i) + " ... "
					+ rt.getComponentProcesses(ids.get(i)).size());
		}
		System.out
				.println("==============================================================================");
		printProcesses();
	...
	public void print(List<SchedulableComponentProcess> l) {
		...
		for (int j = 0; j < l.size(); j++) {
			...
			System.out.println("                - start periods : "
					+ pp.startPeriods);
	...
	public void printEnsembles() {
		...
		for (int i = 0; i < ens.size(); i++) {
			...
			if (ens.get(i).pInfo instanceof PeriodicEnsembleInfo) {
				...
				System.out.println("   ens : start co :" + pe.startPeriodsCoord
						+ "   start mem : " + pe.startPeriodsMem);
