...
public class StateSpaceModel {
	...
	public InaccurateValue[] in;
	public InaccurateValue[] inDerv;
	
	private static double lastTime;

	protected static final double SEC_NANOSECOND_FACTOR = 1000000000;
	
	public StateSpaceModel(Model modelName, Double[] in, Double[] inDerv, Double creationTime) {
...
//		}
	...
	private void initBoundaries(InaccurateValue[] inArr, Double[] arr,  Double creationTime){
