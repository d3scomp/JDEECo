 ...
 * <ul>
 *   <li>{@link cz.cuni.mff.d3s.deeco.model.runtime.impl.ComponentImpl#getProcesses <em>Processes</em>}</li>
...
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	public EList<cz.cuni.mff.d3s.deeco.model.runtime.api.Process> getProcesses() {
		if (processes == null) {
			processes = new EObjectContainmentEList<cz.cuni.mff.d3s.deeco.model.runtime.api.Process>(cz.cuni.mff.d3s.deeco.model.runtime.api.Process.class, this, RuntimeMetadataPackage.COMPONENT__PROCESSES);
		}
		return processes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RuntimeMetadataPackage.COMPONENT__PROCESSES:
