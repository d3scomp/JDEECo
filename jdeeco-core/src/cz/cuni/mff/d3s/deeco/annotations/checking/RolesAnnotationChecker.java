...
public class RolesAnnotationChecker implements AnnotationChecker {
	...
	void checkComponentRolesImplementation(Object obj) throws AnnotationCheckerException {
		...
		List<Field> knowledgeFields = RoleAnnotationsHelper.getNonLocalKnowledgeFields(componentClass, false);
	 ...
	 * @param knowledgeFields Fields of the component class (can be obtained by {@link RoleAnnotationsHelper#getNonLocalKnowledgeFields})
	...
	private void checkRoleFieldsImplementation(List<Field> knowledgeFields, Class<?> roleClass) throws AnnotationCheckerException {
		List<Field> roleFields = RoleAnnotationsHelper.getNonLocalKnowledgeFields(roleClass, true);
